...
while true; do
  ...
  if (( SECONDS >= deadline )); then
    echo "[cdc-postgres-bootstrap] attraction_favorites table was not found before timeout. Run :core:core-api:bootRun or Flyway migrations, then rerun this service." >&2
    exit 1
  fi
