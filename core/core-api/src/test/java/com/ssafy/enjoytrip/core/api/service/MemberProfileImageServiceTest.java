...
class MemberProfileImageServiceTest {
    private static final String PROFILE_IMAGE_OBJECT_KEY =
            "profiles/ssafy/018f0a2a-55c1-7a7c-b3f5-fb2ed9e6b51b.jpg";
    ...
    void createsPresignedUpload() {
        when(uploadUrlGenerator.generate("ssafy", "image/jpeg", "jpg"))
        ...
        ProfileImageUploadUrl upload = service.createPresignedUpload("ssafy", "image/jpeg", "jpg");
    ...
    void updatesOwnedProfileImageWithServerPublicUrl() {
        ...
        service.updateProfileImage("ssafy", PROFILE_IMAGE_OBJECT_KEY);
    ...
    void rejectsProfileImageUpdateForMissingMember() {
        ...
        assertThatThrownBy(() -> service.updateProfileImage("ssafy", PROFILE_IMAGE_OBJECT_KEY))
